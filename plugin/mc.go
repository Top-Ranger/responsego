...
func (q *mc) GetAdminDownload() []byte {
	q.AnswerLock.Lock()
	defer q.AnswerLock.Unlock()

	b, err := json.Marshal(mcResultStruct{Question: q.Question, QuestionAnswers: q.QuestionAnswers, AnswerCount: q.AnswerCount, Submitted: q.NumberSubmitted})
	if err != nil {
